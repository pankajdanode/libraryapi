...
exports.author_create_get = function(req, res, next) {
    res.render('author/add', { title: 'Create Author'});
...
exports.author_create_post = function(req, res, next) {
    ...
    //var errors = req.getValidationResul();
    ...
    if (errors) {
        res.render('author/add', { title: 'Create Author', author: author, errors: errors});
        return;
    } 
    else{
...
exports.author_delete_get = function(req, res, next) {
    async.parallel({
        ...
        if (err) { return next(err); }
        //Successful, so render
        res.render('author/delete', { title: 'Delete Author', author: results.author, author_books: results.authors_books } );
    });
